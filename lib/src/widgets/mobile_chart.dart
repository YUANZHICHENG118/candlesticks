                            ...
                            child: Container(
                              child: Padding(
                                ...
                                child: KDJWidget(
                                  ...
                                  barWidth: widget.candleWidth,
                                  index: widget.index,
                                  high:150, kColor: widget.style.kColor,dColor: widget.style.dColor,jColor: widget.style.jColor,),
                              ),
                            ),
                          ),
                            ...
                            child: Container(
                              child: Padding(
                                ...
                                child: MACDWidget(
                                  ...
                                  barWidth: widget.candleWidth,
                                  index: widget.index,
                                  high:600, difColor: widget.style.difColor,deaColor: widget.style.deaColor,positiveColor: widget.style.secondaryBear,negativeColor: widget.style.primaryBear),
                              ),
                            ),
                          ),
                            ...
                            child: Container(
                              child: Padding(
                                ...
                                child: RSIWidget(
                                    ...
                                    barWidth: widget.candleWidth,
                                    index: widget.index,
                                    high:150, rsi1Color: widget.style.kColor,rsi2Color: widget.style.dColor,rsi3Color: widget.style.jColor,lineWidth: 1,),
                              ),
                            ),
                          ),
                          SizedBox(
